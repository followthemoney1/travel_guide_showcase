...
class _$LanguageTearOff {
  ...
  _Language call({String id = '0', String name = '', String flagPath = ''}) {
    return _Language(
      id: id,
      name: name,
      flagPath: flagPath,
...
abstract class $LanguageCopyWith<$Res> {
  ...
  $Res call({String id, String name, String flagPath});
}
...
class _$_Language extends _Language {
  const _$_Language({this.id = '0', this.name = '', this.flagPath = ''})
      : super._();
  ...
  @override
  String toString() {
    return 'Language(id: $id, name: $name, flagPath: $flagPath)';
  }
        ...
        (other is _Language &&
            ...
            (identical(other.flagPath, flagPath) ||
                const DeepCollectionEquality()
                    .equals(other.flagPath, flagPath)));
  }
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(flagPath);
...
abstract class _Language extends Language {
  const factory _Language({String id, String name, String flagPath}) =
      _$_Language;
